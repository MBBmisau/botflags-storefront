...
ARG NEXT_PUBLIC_ENABLE_PAYSTACK_PAYMENTS
ENV NEXT_PUBLIC_ENABLE_PAYSTACK_PAYMENTS=${NEXT_PUBLIC_ENABLE_PAYSTACK_PAYMENTS:-false}

ARG NEXT_PUBLIC_GA_MEASUREMENT_ID
ENV NEXT_PUBLIC_GA_MEASUREMENT_ID=${NEXT_PUBLIC_GA_MEASUREMENT_ID}

ARG NEXT_PUBLIC_GA_DEBUG
ENV NEXT_PUBLIC_GA_DEBUG=${NEXT_PUBLIC_GA_DEBUG:-false}
...
ARG NEXT_PUBLIC_ENABLE_PAYSTACK_PAYMENTS
ENV ENABLE_PAYSTACK_PAYMENTS=${NEXT_PUBLIC_ENABLE_PAYSTACK_PAYMENTS:-false}
